...
int main() {
    ...
    arp_cache.add_entry(ip1, mac1, 1); // Using interface_id = 1
    ...
    arp_cache.add_entry(ip_conflict, mac_orig, 1); // Using interface_id = 1
    ...
    arp_cache.add_entry(ip_conflict, mac_new_conflict, 1); // Using interface_id = 1
                                                       // This should trigger the warning in ARPCache
    ...
    arp_cache.add_entry(ip_failover, primary_mac, 1); // Using interface_id = 1

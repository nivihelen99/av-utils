...
*   **Specialized Arrays and Storage:** `chrono_ring.h` ([ChronoRing](docs/README_chrono_ring.md)), [DynamicBitset](docs/README_DynamicBitset.md), `GenerationalArena.h` ([GenerationalArena](docs/README_GenerationalArena.md)), `instrumented_ring_buffer.h`, `persist_array.h`, `ring_buffer.h`, `SlotMap.h` ([SlotMap](docs/README_SlotMap.md)), `small_vector.h`, [SuffixArray](docs/README_SuffixArray.md).
